...
router.post("/signup", multipleFieldsUploadWithDifferentName([{name: "picture", maxCount: 1}, {name: "logo", maxCount: 1}], ['image'], true), OrganizerAuthValidation.registerParams, OrganizerAuthValidation.validateFormData, organizerAuthController.register);
